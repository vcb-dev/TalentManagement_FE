...
const progressStarVariants = cva('h-4 w-4', {
  ...
  compoundVariants: [
    { variant: 'primary', filled: false, className: 'opacity-45 grayscale' },
    { variant: 'gold', filled: true, className: 'drop-shadow-[0_1px_2px_rgba(180,120,0,0.35)]' },
    { variant: 'primary', filled: true, className: 'drop-shadow-[0_1px_2px_rgba(79,70,229,0.22)]' },
  ],
  defaultVariants: { variant: 'primary', filled: false },
})
