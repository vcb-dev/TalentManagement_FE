...
export function CompanyLandingSettingsScreen() {
  ...
  return (
    <div className="w-full space-y-6">
      <PageHeader
        title="Trang giới thiệu công ty"
        description="Chỉnh sửa nội dung hiển thị tại trang chủ công khai (/) bằng các ô nhập có nhãn. Ảnh có thể tải lên máy chủ (hiển thị xem trước ngay trên form) hoặc dùng đường dẫn tĩnh trong dự án (ví dụ /Image_VCB/...). Sau khi lưu, mọi người sẽ thấy bản mới khi tải lại trang."
        gradientTitle
        surface
        variant="flat"
